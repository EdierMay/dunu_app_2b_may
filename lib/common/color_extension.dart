...
class TColor {
  static Color get primary => const Color(
      0xfffe6dcb); //Miros - esta nomenclatura se llama Hexadecimal (ARGB)
  static Color get secondary => const Color(
      0xff3F414E); //Miros - Para convertir  un Hex a ARGB solo se agrega 0xff al inicio en lugar de #
...
extension HexColor on Color {
  //Funcion para convertir hex al formato que ocupa dart (ARGB)
