    ...
    try {
      ...
      if (email.isEmpty || password.isEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text("Por favor, ingresa un correo y una contraseña")),
        );
        return;
      }
  ...
  Future<UserCredential?> signInWithGoogle() async {
    try {
      ...
      final GoogleSignIn googleSignIn = GoogleSignIn(
        clientId:
            '822034519769-122hsatfo97mhccrcfnbj0rg7dpo9h0n.apps.googleusercontent.com', // Copia tu Client ID desde Google Cloud
      );
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "O inicia sesión con tu correo eléctronico",
                textAlign: TextAlign.center,
                style: TextStyle(
              ...
              const SizedBox(height: 35),
              RoundTextField(
                  controller: _emailController, hintText: "Correo electronico"),
                    ...
                    IconButton(
                      ...
                      icon: Icon(
                        ...
                        isTrue
                            ...
                            : Icons
                                .check_box_outline_blank_rounded, //Icono de checkbox True
                        color: isTrue
                            ? TColor.primary
                            : TColor
                                .secondaryText, //Cambio de color según etsado
                      ),
                    ),
                  ],
                ),
